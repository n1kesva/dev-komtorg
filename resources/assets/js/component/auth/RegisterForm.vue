<template>
  <v-layout row justify-center>
    <v-dialog v-model="dialog" persistent max-width="500px">
      <v-btn color="primary" flat slot="activator">РЕГИСТРАЦИЯ</v-btn>
      <v-card>
        <v-card-title>
          ...
          <v-container grid-list-md>
            <v-layout wrap>
              ...
              <v-flex xs12>
               ...
               <v-flex xs12>
                <v-text-field label="Подвтердите пароль" type="password" required></v-text-field>
              </v-flex>
            </v-layout>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" flat @click.native="dialog = false">Регистрация</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </v-layout>
